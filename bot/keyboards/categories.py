...
categories_keyboard.add(
    InlineKeyboardButton(
        CommandEnum.ADD_CATEGORY.value, callback_data=CommandEnum.ADD_CATEGORY.value
    )
)
categories_keyboard.add(
    InlineKeyboardButton(
        CommandEnum.LIST_CATEGORY.value, callback_data=CommandEnum.LIST_CATEGORY.value
    )
)
...
retrieve_category_keyboard.add(
    InlineKeyboardButton(
        CommandEnum.DEL_CATEGORY.value, callback_data=CommandEnum.DEL_CATEGORY.value
    )
)
retrieve_category_keyboard.add(
    InlineKeyboardButton(
        CommandEnum.FILTER_CATEGORY.value,
