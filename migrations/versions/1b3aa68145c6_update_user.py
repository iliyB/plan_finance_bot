...
Revision ID: 1b3aa68145c6
Revises: e373af3eeb29
Create Date: 2022-04-20 13:12:03.948564
...
revision = '1b3aa68145c6'
down_revision = 'e373af3eeb29'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.add_column('user', sa.Column('language_code', sa.String(length=16), nullable=True))
